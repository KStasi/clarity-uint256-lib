...
describe("big-uint contract test suite", () => {
  ...
  describe("deploying an instance of the contract", () => {
    ...
    it("should return valid result for typical cases", async () => {
      let a = "83e8223b132b0fa8014650f9a2da5a3e25edd4eea75b888e208e440eb14c0780";
      let b = "afbd122d3c1dd8ada1cb727ef867ac6286401d81af2e18c471fc6ea7e769e21f";
      ...
      assert.equal(result, "(ok (tuple (i0 u3721438289703004385) (i1 u11750387825554622580) (i2 u12406839112777703700) (i3 u10559448773639400000)))");
    });
  });
